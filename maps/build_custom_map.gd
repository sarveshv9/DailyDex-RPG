...
func _init():
	...
	var err = ResourceSaver.save(final_scene, "res://maps/my_custom_map.tscn")
	
	if err != OK:
		printerr("Failed to save my_custom_map.tscn")
		quit(1)
		return
