...
func _init_battle() -> void:
	...
	# Visuals
	player_sprite.texture = CreatureSprites.generate_creature_sprite(player_creature.element_type, player_creature.color)
	enemy_sprite.texture = CreatureSprites.generate_creature_sprite(enemy_creature.element_type, enemy_creature.color)
